...
class ConferenceForm(messages.Message):
    ...
    month = messages.IntegerField(
        7, variant=messages.Variant.INT32)
    maxAttendees = messages.IntegerField(
        8, variant=messages.Variant.INT32)
    seatsAvailable = messages.IntegerField(
...
class ConferenceForms(messages.Message):
    ...
    items = messages.MessageField(
        ConferenceForm, 1, repeated=True)
...
class ConferenceQueryForms(messages.Message):
    ...
    filters = messages.MessageField(
        ConferenceQueryForm, 1, repeated=True)


# - - - Classes for Speaker and Speaker - - - - - - - - - - - - - - - - - - - -
